...
| item                            | from              | to                                      |
|---------------------------------|-------------------|-----------------------------------------|
| `RxCoalescingOptions`           | `@rx-angular/cdk` | `@rx-angular/cdk/zone-less/coalescing`  |
| `coalescingObj`                 | `@rx-angular/cdk` | `@rx-angular/cdk/zone-less/coalescing`  |
| `coalesceWith`                  | `@rx-angular/cdk` | `@rx-angular/cdk/zone-less/coalescing`  |
| `coalescingManager`             | `@rx-angular/cdk` | `@rx-angular/cdk/zone-less/coalescing`  |
| `CoalescingManager`             | `@rx-angular/cdk` | `@rx-angular/cdk/zone-less/coalescing`  |

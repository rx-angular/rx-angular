...
export type ActionTransforms<T> = {
  [K in keyof T]?: ActionTransformFn<any, any>;
};
...
type DispatcherFromActionsWithoutTransformsOf<
  T extends Actions,
...
export type ActionDispatchersOf<
  T extends Actions,
  I extends ActionTransforms<T>
> = DispatcherFromActionsWithoutTransformsOf<T, I> & DispatcherFromTransformsOf<I>;

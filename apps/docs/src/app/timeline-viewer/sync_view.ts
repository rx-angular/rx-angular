...
export class SyncView {
  private static _originalPanel: any;
  private static _flameChartDelegate: any;
  private static _parentElement: any;
  private static windowLeft: any;
  private static windowRight: any;
  ...
  static setWindowPositionPatch(start, end, viewerInstance) {
    ...
    const selectionPcts = SyncView.originalSetWindowPosition(this, start, end);
   ...
   * @param {*}
   */
  static originalSetWindowPosition(_this, start, end) {
    const clientWidth = _this._parentElement.clientWidth;
    ...
    _this._setWindow(windowLeft, windowRight);

...
marks the component and all its ancestors as dirty and re-renders the whole component tree. [Read more about this here](../guides/performance/rendering-issues-in-angular.md)

...
- Allow passing external attributes to the viewport element (`[viewportAttrs]="[{name: '...', value: '...'}]"`)
...
<ReactPlayer
  playing
  controls
  url="https://user-images.githubusercontent.com/4904455/231340169-f65efe6c-863d-49e8-9f4f-183bb38e1b2a.mp4"
/>

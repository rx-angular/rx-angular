...
<TabItem value="shortcut" label="trackBy shortcut">
...
<TabItem value="fn" label="trackByFunction">
...
| `patchZone`           | `boolean`                                                          | _default: `true`_ if set to `false`, the `RxFor` will operate out of `NgZone`. See [NgZone optimizations](../guides/performance/ngzone-optimizations.md)                                                                                                                                         |
| `parent` (deprecated) | `boolean`                                                          | _default: `true`_ if set to `false`, the `RxFor` won't inform its host component about changes being made to the template. More performant, `@ViewChild` and `@ContentChild` queries won't work. [Handling view and content queries](../guides/performance/handling-view-and-content-queries.md) |

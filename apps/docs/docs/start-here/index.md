...
| --- | --- | --- | --- |
| [`@rx-angular/state`](../packages/state/) | you need global/shared, complex-derived, or async-heavy state (signals already cover local state) | v21.1.1 | `^21.0.0` |
| [`@rx-angular/template`](../packages/template/) | you need high-performance rendering — large live lists, concurrent scheduling, reactive suspense/error/complete | v21.2.0 | `^21.0.0` |
| [`@rx-angular/cdk`](../packages/cdk/) | you are building on the primitives (render strategies, coercing, transformations) — the helper layer | v21.1.0 | `^21.0.0` |
| [`@rx-angular/isr`](../packages/isr/) | you run Angular SSR and want Incremental Static Regeneration | v21.0.1 | `@angular/ssr ^21.0.0` |
| [`@rx-angular/eslint-plugin`](../packages/eslint-plugin/) | you want to enforce reactive discipline / keep a codebase zoneless-ready | v3.0.0 | eslint `>=8` |

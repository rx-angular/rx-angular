...
Some material formerly documented here has moved to the parts of the docs where you use
it (per the helper-layer positioning): render strategies and concurrent scheduling are
documented in the **Template** journey; the transformation helpers surface in the
**State** journey.

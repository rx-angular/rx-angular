...
import { MENU_ITEMS as LET_MENU_ITEMS } from './structural-directives/let/let.menu';
...
import { MENU_ITEMS as EMBEDDED_VIEW_MENU } from './structural-directives/cd-embedded-view/cd-embedded-view.menu';

...
@Component({
  ...
  template: `
    ...
    <div class="case-interaction">
      <button (click)="nextValueSubject.next('STATIC_VALUE')">
        next static value
      </button>
      <button (click)="nextValueSubject.next('STATIC_PROJECT')">
        next static project
      </button>
      <button (click)="nextValueSubject.next('STATIC_KEY_PROJECT')">
        next static project
      </button>
      <button (click)="nextValueSubject.next('EMPTY')">next empty</button>
      <button (click)="nextValueSubject.next('SINGLE')">
        next single-shot
      </button>
...
export class RxStateParent01Component extends BaseComponent

...
import {
  ReactIdlePriority,
  ReactImmediatePriority, ReactLowPriority,
  ReactNoPriority, ReactNormalPriority, ReactUserBlockingPriority,
  scheduleOnReactQueue
} from '../scheduling/scheduler/react-concurrent-scheduler';
...
export function createNoPriorityStrategyCredentials(): StrategyCredentials {
  return {
    ...
    behavior: (work: any, scope: any) => {
      return (o$) =>
        o$.pipe(scheduleOnReactQueue(work, { priority:  ReactNoPriority, scope }));
    },
  };
}
...
export function createImmediateStrategyCredentials(): StrategyCredentials {
  return {
    ...
    behavior: (work: any, scope: any) => {
      return (o$) =>
        o$.pipe(
          scheduleOnReactQueue(work, { priority:  ReactImmediatePriority, scope })
        );
    },
  };
}
...
export function createUserBlockingStrategyCredentials(): StrategyCredentials {
  return {
    ...
    behavior: (work: any, scope: any) => {
      return (o$) =>
        o$.pipe(
          scheduleOnReactQueue(work, { priority:  ReactUserBlockingPriority, scope })
        );
    },
  };
}
...
export function createLowStrategyCredentials(): StrategyCredentials {
  return {
    ...
    behavior: (work: any, scope: any) => {
      return (o$) =>
        o$.pipe(scheduleOnReactQueue(work, { priority:  ReactLowPriority, scope }));
    },
  };
}

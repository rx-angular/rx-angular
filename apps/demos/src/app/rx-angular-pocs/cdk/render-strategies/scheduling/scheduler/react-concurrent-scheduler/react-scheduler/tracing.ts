...
export interface InteractionsRef { current: Set<Interaction> }

export interface SubscriberRef { current: Subscriber | null }
...
const interactionsRef: InteractionsRef = null;

// Listener(s) to notify when interactions begin and end.
const subscriberRef: SubscriberRef = null;

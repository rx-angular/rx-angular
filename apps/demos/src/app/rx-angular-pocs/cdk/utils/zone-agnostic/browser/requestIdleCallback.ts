...
export const cancelIdleCallback: CancelIdleCallback =
  typeof window !== 'undefined'
    ? ((window as any).cancelIdleCallback
        ? getZoneUnPatchedApi('cancelIdleCallback')
        : false) ||
      function (idleId: IdleId): void {
        console.warn(
          'cancelIdleCallback not implemented. Use clearTimeout as fallback',
        );
        clearTimeout(idleId);
      }
    : () => {};
...
export const requestIdleCallback: RequestIdleCallback =
  typeof window !== 'undefined'
    ? ((window as any).requestIdleCallback
        ? getZoneUnPatchedApi('requestIdleCallback')
        : false) ||
      function (cb: Function) {
        console.warn(
          'requestIdleCallback not implemented. Use setTimeout as fallback',
        );

    ...
    <rxa-visualizer>
      <div visualizerHeader>
        ...
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.Promise)"
        >
          Promise
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.setTimeout)"
        >
          setTimeout
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.setInterval)"
        >
          setInterval
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.animationFrame)"
        >
          animationFrame
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.idleCallback)"
        >
          idleCallback
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.background)"
        >
          background
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.userVisible)"
        >
          userVisible
        </button>
        <button
          mat-raised-button
          [unpatch]
          (click)="scheduleByPrio(prios.userBlocking)"
        >
          userBlocking
        </button>
      </div>

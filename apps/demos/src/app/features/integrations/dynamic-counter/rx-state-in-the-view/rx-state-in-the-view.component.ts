    ...
    <div class="counter">
      ...
      <mat-form-field>
        ...
        <input
          ...
          min="0"
          matInput
          [value]="initialCounterState.count"
          (input)="countChange.next(count.value)"
        />
      </mat-form-field>
      <br />
      ...
      <mat-form-field>
        ...
        <input
          ...
          min="0"
          matInput
          [value]="tickSpeed$ | push"
          (input)="set({ tickSpeed: tickSpeed.value })"
        />
      </mat-form-field>
      ...
      <mat-form-field>
        ...
        <input
          ...
          min="0"
          matInput
          [value]="countDiff$ | push"
          (input)="set({ countUp: countDiff.value })"
        />
      </mat-form-field>
    </div>
  `,

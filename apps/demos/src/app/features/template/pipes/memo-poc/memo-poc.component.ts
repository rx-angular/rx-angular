    ...
    <div class="row mb-2">
      <div class="col">
        ...
        >
          ...
          <mat-button-toggle [value]="displayStates.fnInTpl"
            >Fn in Tpl</mat-button-toggle
          >
          <mat-button-toggle [value]="displayStates.purePipe"
            >purePipe</mat-button-toggle
          >
          <mat-button-toggle [value]="displayStates.pureMemoPipe"
            >pureMemoPipe</mat-button-toggle
          >
          <mat-button-toggle [value]="displayStates.memoPipe"
            >memoPipe</mat-button-toggle
          >
        </mat-button-toggle-group>

        <button mat-raised-button (click)="changeNumPositions(-1)">
          decrement (-1)
        </button>
        <button mat-raised-button (click)="changeNumPositions(+1)">
          increment (+1)

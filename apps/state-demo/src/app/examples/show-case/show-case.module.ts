...
import { ShowCase1ContainerComponent } from './1/show-case-1.container.component';
import { Counter1Component } from './1/show-case-1.component';
...
export const ROUTES = [
  ...
  {
    path: 'step-1',
    component: ShowCase1ContainerComponent,
  },
  {
    path: 'solution',
    component: DynamicCounterContainerComponent,
